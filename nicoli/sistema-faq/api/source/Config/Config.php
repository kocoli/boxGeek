...
const CONF_URL_BASE = "http://localhost/sistema-faq/"; // URL base do site, geralmente localhost em desenvolvimento
const CONF_URL_TEST = "http://localhost/sistema-faq/"; // URL base do site, geralmente localhost em desenvolvimento
